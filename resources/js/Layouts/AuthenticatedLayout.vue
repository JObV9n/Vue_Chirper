            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <!--                                Navigation link to Chirps site-->
                                <NavLink :active="route().current('chirp.index')" :href="route('chirp.index')">
                                    Chirp
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('chirp.index')" :active="route().current('chirp.index')">
                            Chirp
                        </ResponsiveNavLink>
